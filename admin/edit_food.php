...
<head>
    ...
    <style>
        * { font-family: 'Nunito', sans-serif; }
        ...
        .food-preview { width: 100px; height: 100px; object-fit: cover; border-radius: 10px; margin-bottom: 10px; }
            ...
            <div class="form-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="3"><?= $food['description'] ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Price ($)</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category">
                            ...
                            <option value="Asian" <?= $food['category'] == 'Asian' ? 'selected' : '' ?>>Asian</option>
                    ...
                    <div class="form-group">
                        <label>Image</label>
                        <?php if ($food['image']): ?>
                            <img src="../uploads/<?= $food['image'] ?>" class="food-preview">
                        <?php endif; ?>
